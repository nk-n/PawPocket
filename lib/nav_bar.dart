      ...
      bottomNavigationBar: BottomNavigationBar(
        items: const [
          BottomNavigationBarItem(
            icon: ImageIcon(AssetImage("assets/images/nav_bar_pet.png")),
            label: "Home",
          ),
          BottomNavigationBarItem(
            icon: ImageIcon(AssetImage("assets/images/nav_bar_calendar.png")),
            label: "Calendar",
          ),
          BottomNavigationBarItem(
            icon: ImageIcon(AssetImage("assets/images/nav_bar_community.png")),
            label: "Community",
          ),
